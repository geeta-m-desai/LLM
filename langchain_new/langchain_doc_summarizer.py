...
if st.button("Summarize"):
    ...
    if not openai_api_key.strip() or not source_doc:
        ...
        try:
            ...
            summary = chain.run(input_documents=search, question="Write a summary of the document. Provide list of research papers discussed in the document in a bullet list.")
